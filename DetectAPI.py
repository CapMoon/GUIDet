...
class DetectAPI:
    def __init__(self, weights='weights/yolov5s.pt', data='data/coco128.yaml', source='b1/2904.jpg' , imgsz=None, conf_thres=0.25,
...
if __name__ == '__main__':
    img = cv2.imread('D://yolov5_new//b1//2904.jpg')
    detect_api = DetectAPI(weights='weights/yolov5_CFP+WDLoss.pt', source='b1/2904.jpg', data='data/VINS.yaml',exist_ok=True)
